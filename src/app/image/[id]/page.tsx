...
import { getAllCommentsForImage, getSingleImage } from '@/lib/db/queries';
import { Badge } from '@/components/ui/badge';
import { Avatar, AvatarFallback, AvatarImage } from '@/components/ui/avatar';
import { ArrowLeft } from 'lucide-react';
import Link from 'next/link';
import ClickButton from '@/components/ShareButton';
import DownloadButton from '@/components/DownloadButton';
import LikeButton from '@/components/LikeButton';
import CommentSection from './Comment';
import { AddToCollection } from '@/app/collections/add-to-collections';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <AddToCollection imageId={Number(id)} />
              <DownloadButton
                imageUrl={imageUrl}
                title={title}
                key={`download-${id}`}
